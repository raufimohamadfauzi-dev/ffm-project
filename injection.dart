...
Future<void> configureDependencies({AppDatabase? database}) async {
  ...
  getIt.registerLazySingleton<GetRecurringTransactions>(() => GetRecurringTransactions(db));
  getIt.registerLazySingleton<HijriCalendarService>(() => HijriCalendarService(db));
  getIt.registerLazySingleton<OfflineAiEngineService>(OfflineAiEngineService.new);
}
