...
class _SummaryPageState extends State<SummaryPage> {
  ...
  Future<_SummaryData> _loadSummary() async {
    ...
    final recurring = await getIt<GetRecurringTransactions>()(AppContext.householdId);
    ...
    final hasAccounts = accounts.any(
      (a) => a.householdId == AppContext.householdId && !a.isArchived,
    );
                          ...
                          child: Align(
                            ...
                            child: AnimatedContainer(
                              ...
                              decoration: BoxDecoration(
                                color: point.amount == maxAmount && hasExpense
                                    ? scheme.primary
