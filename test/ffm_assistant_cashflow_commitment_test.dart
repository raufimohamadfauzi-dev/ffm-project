...
void main() {
  ...
  test(
    'F2.5 offline: analisis arus kas, cicilan dan target dihitung secara deterministik (surplus)',
    () async {
  ...
  test(
    'F2.5 offline: analisis arus kas menyatakan defisit target jika cashflow hanya cukup untuk cicilan',
    () async {
      final now = DateTime(2026, 9, 15);
      ...
      expect(
        intent.response,
        contains('cukup untuk cicilan utang, namun belum mencukupi penuh target tabungan'),
      );
    },
  );
}
