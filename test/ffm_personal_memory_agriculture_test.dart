...
void main() {
  test('Mengekstrak informasi pertanian dan kebun dari pesan user', () {
    ...
    // 1. Luas lahan
    final insightLahan = service.extractFromMessage(
      'lahan sawah saya seluas 2 hektar',
    );
    ...
    final insightKomoditas = service.extractFromMessage(
      'tanam padi dan jagung di kebun',
    );
    ...
    // 3. Perkiraan panen
    final insightPanen = service.extractFromMessage(
      'perkiraan panen pada 20 Oktober 2026',
    );
    ...
    // 4. Nomor meteran PLN
    final insightMeteran = service.extractFromMessage(
      'nomor meteran listrik sawah adalah 14238765432',
    );
