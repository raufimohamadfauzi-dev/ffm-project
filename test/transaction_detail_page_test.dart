...
void main() {
  ...
  testWidgets(
    'TransactionDetailPage merender rincian transaksi lengkap dan item belanja dengan subtotal',
    (tester) async {
      ...
      expect(
        find.text('Jumlah: 2.0 pouch · Harga satuan: Rp 35000'),
        findsOneWidget,
      );
      expect(find.text('Beras Pandan Wangi 5kg'), findsOneWidget);
      expect(
        find.text('Jumlah: 1.0 karung · Harga satuan: Rp 80000'),
        findsOneWidget,
      );
  ...
  testWidgets('Tombol Edit dan Hapus memicu callback dengan tepat', (
    tester,
  ) async {
