  ...
  group('DebtPayoffStrategyPage Widget Tests', () {
    ...
    testWidgets('renders empty state when no debts exist', (tester) async {
      await tester.pumpWidget(
        const MaterialApp(home: DebtPayoffStrategyPage()),
      );
      await tester.pumpAndSettle();

      expect(find.text('Bebas Hutang! 🎉'), findsOneWidget);
      expect(
        find.textContaining('tidak memiliki catatan hutang aktif'),
        findsOneWidget,
      );
    });

    testWidgets(
      'renders simulation cards, strategy toggle, and priority list when debts exist',
      (tester) async {
