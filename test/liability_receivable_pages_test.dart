...
void main() {
  ...
  testWidgets(
    'LiabilityListPage menampilkan 7 tab klasifikasi dan kotak pencarian',
    (tester) async {
      ...
      await tester.pumpWidget(const MaterialApp(home: LiabilityListPage()));
  ...
  testWidgets(
    'ReceivableListPage menampilkan 7 tab klasifikasi dan kotak pencarian',
    (tester) async {
      final now = DateTime(2026, 9, 3);
  ...
  testWidgets(
    'LiabilityDetailPage menampilkan tombol Catat Pembayaran Hutang dan riwayat',
    (tester) async {
      final now = DateTime(2026, 9, 3);
      ...
      await tester.pumpWidget(
        MaterialApp(home: LiabilityDetailPage(liability: liability)),
      );
      await tester.pumpAndSettle();
      ...
      await tester.scrollUntilVisible(find.text('Riwayat Pembayaran Kas'), 300);
      expect(find.text('Riwayat Pembayaran Kas'), findsOneWidget);
    },
  );

  testWidgets(
    'ReceivableDetailPage menampilkan tombol Terima Pembayaran Piutang dan riwayat',
    (tester) async {
      final now = DateTime(2026, 9, 3);
      ...
      await tester.pumpWidget(
        MaterialApp(home: ReceivableDetailPage(receivable: receivable)),
      );
      await tester.pumpAndSettle();
      ...
      // Scroll untuk memeriksa riwayat
      await tester.scrollUntilVisible(find.text('Riwayat Penerimaan Kas'), 300);
