...
class FfmAssistantSelfDescriptionService {
  ...
  String build({
    ...
    final currentActions = <String>[
      ...
      'memberikan edukasi literasi keuangan keluarga (budgeting, menabung, cashflow, manajemen finansial)',
...
${slmConfigured ? 'Jika model SLM lokal siap, aku juga dapat memahami bahasa alami/gambar dan membantu narasi atau insight. Jika belum siap, aku memakai aturan lokal dan tetap memberi tahu statusnya.' : 'Model SLM lokal belum dikonfirmasi siap; saat ini aku mengandalkan aturan lokal dan tidak akan mengklaim kemampuan vision/reasoning model.'}
