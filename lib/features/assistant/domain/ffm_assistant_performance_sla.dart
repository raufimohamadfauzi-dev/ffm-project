...
class FfmAssistantPerformanceSLA {
  ...
  static const int analysisQueryTarget =
      10000; // 10 seconds for analysis queries
  static const int complexQueryTarget = 15000; // 15 seconds for complex queries

  // Component performance targets (in milliseconds)
  static const int databaseQueryP90 =
      100; // 90th percentile for database queries
  static const int databaseQueryP99 =
      200; // 99th percentile for database queries
  static const int analysisEngineP90 =
      500; // 90th percentile for analysis engine
  static const int analysisEngineP99 =
      1000; // 99th percentile for analysis engine
  ...
  static const int overallResponseP90 =
      5000; // 90th percentile for overall response
  static const int overallResponseP99 =
      10000; // 99th percentile for overall response
  ...
  static const double cacheHitRateExcellent =
      0.85; // 85% cache hit rate is excellent

  // LLM evaluation targets
  static const double factualityScoreTarget =
      0.8; // 80% factuality score target
  static const double hallucinationScoreTarget =
      0.2; // 20% hallucination score target (lower is better)
  static const double intentFollowingScoreTarget =
      0.9; // 90% intent following score target
  static const double overallQualityScoreTarget =
      0.8; // 80% overall quality score target

  // Intent classification targets
  static const double intentClassificationAccuracyTarget =
      0.9; // 90% accuracy target
  ...
  static String getEvaluationScoreGrade(double score, double target) {
    return getPerformanceGrade(score, target, lowerIsBetter: false);
  }
}
