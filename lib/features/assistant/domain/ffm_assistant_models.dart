...
abstract final class FfmAssistantCatalog {
  static const pages = <FfmAssistantPage>[
    ...
    FfmAssistantPage(
      ...
      name: 'Aktivitas',
      description: 'Melacak aktivitas harian berdurasi serta mengelola Catatan Harian, Tugas, dan Rutinitas secara terpisah.',
  ...
  static String detailFor(FfmAssistantDestination destination) =>
      switch (destination) {
        ...
        FfmAssistantDestination.activity => 'Aktivitas & Jurnal memiliki empat bagian terpisah: aktivitas bertimer untuk melacak kegiatan dan lama waktunya, Catatan Harian untuk teks bebas, Tugas untuk tindakan satu kali, serta Rutinitas untuk kebiasaan berulang dengan tanda pelaksanaan per hari. Beberapa aktivitas dapat aktif bersamaan; pembaruan atau selesai pada satu aktivitas tidak otomatis menutup aktivitas lain. Catatan Harian, Tugas, dan Rutinitas tidak mengubah sesi aktivitas dan hanya dapat diarsipkan lunak lewat Agent.',
