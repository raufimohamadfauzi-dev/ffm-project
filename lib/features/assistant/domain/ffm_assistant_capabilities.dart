...
class FfmAssistantCapabilityRegistry {
  ...
  static final List<FfmAssistantCapability> all = List.unmodifiable([
    ...
    const FfmAssistantCapability(
      id: 'read.monitoring_jobs',
      label: 'Baca jadwal pemantauan',
      description: 'Membaca daftar jadwal pemantauan otomatis yang aktif.',
      risk: FfmAssistantCapabilityRisk.readOnly,
      destination: FfmAssistantDestination.autonomyMonitor,
      readOnly: true,
    ),
    const FfmAssistantCapability(
      id: 'read.monitoring_evaluation',
      label: 'Evaluasi pemantauan',
      description: 'Mengevaluasi kondisi finansial berdasarkan preset job pemantauan tanpa mutasi saldo.',
      risk: FfmAssistantCapabilityRisk.readOnly,
      destination: FfmAssistantDestination.autonomyMonitor,
      readOnly: true,
    ),
    ...
    const FfmAssistantCapability(
      ...
      destination: FfmAssistantDestination.autonomyMonitor,
      parameterNames: ['preset', 'cadence', 'time', 'day', 'category'],
    ),
    const FfmAssistantCapability(
    ...
    const FfmAssistantCapability(
      id: 'verify.monitoring_job',
      label: 'Verifikasi status jadwal pemantauan',
      description: 'Membaca kembali status jadwal pemantauan setelah aktivasi, jeda, atau pembatalan.',
      risk: FfmAssistantCapabilityRisk.readOnly,
      readOnly: true,
    ),
    const FfmAssistantCapability(
      id: 'mutate.monitoring_job_save',
      label: 'Simpan jadwal pemantauan',
      description: 'Menyimpan dan mengaktifkan jadwal pemantauan otonom.',
      risk: FfmAssistantCapabilityRisk.mutation,
      requiresConfirmation: true,
    ),
    const FfmAssistantCapability(
      id: 'mutate.monitoring_job_pause',
      label: 'Jeda jadwal pemantauan',
      description: 'Menjeda sementara eksekusi jadwal pemantauan.',
      risk: FfmAssistantCapabilityRisk.mutation,
      requiresConfirmation: true,
      parameterNames: ['jobId'],
    ),
    const FfmAssistantCapability(
      id: 'mutate.monitoring_job_resume',
      label: 'Lanjutkan jadwal pemantauan',
      description: 'Mengaktifkan kembali jadwal pemantauan yang sempat dijeda.',
      risk: FfmAssistantCapabilityRisk.mutation,
      requiresConfirmation: true,
      parameterNames: ['jobId'],
    ),
    const FfmAssistantCapability(
      id: 'mutate.monitoring_job_cancel',
      label: 'Batalkan jadwal pemantauan',
      description: 'Membatalkan dan menghentikan jadwal pemantauan otonom secara permanen.',
      risk: FfmAssistantCapabilityRisk.mutation,
      requiresConfirmation: true,
      parameterNames: ['jobId'],
    ),
    ...
    const FfmAssistantCapability(
      id: 'mutate.complete',
      label: 'Selesaikan data atau pengingat',
      description: 'Menandai data atau occurrence pengingat sebagai selesai.',
      risk: FfmAssistantCapabilityRisk.mutation,
      requiresConfirmation: true,
    ),
    const FfmAssistantCapability(
