...
class FfmAssistantCapabilityRegistry {
  ...
  static final List<FfmAssistantCapability> all = List.unmodifiable([
    ...
    const FfmAssistantCapability(
      ...
      description: 'Membaca kembali Kategori setelah perubahan nama atau arsip lunak yang lolos guard.',
      risk: FfmAssistantCapabilityRisk.readOnly,
      readOnly: true,
    ),
    const FfmAssistantCapability(
      ...
      description: 'Membaca kembali Rekening setelah perubahan nama atau arsip lunak yang lolos guard referensi.',
      risk: FfmAssistantCapabilityRisk.readOnly,
      readOnly: true,
    ),
    const FfmAssistantCapability(
