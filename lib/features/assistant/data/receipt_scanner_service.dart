...
- Struk pembelian TOKEN LISTRIK PLN: tulis sebagai satu transaksi expense; isi budget_name dengan "Listrik" atau pos anggaran utilitas yang cocok; PISAHKAN secara eksplisit antara NOMINAL TOKEN/STROOM MURNI (masukkan ke items sebagai harga barang atau note) dan BIAYA ADMIN BANK (masukkan ke admin_fee). Nilai total "amount" adalah nominal token + biaya admin. Masukkan nomor token 20 digit (format 5 blok: xxxx-xxxx-xxxx-xxxx-xxxx atau 20 angka), IDPEL / nomor meteran, dan jumlah kWh ke note dan items.
