        ...
        build: (context) => [
          ...
          if (assets.isNotEmpty)
            _section(
              'Aset',
              assets
                  .map((item) => '${item.name}: ${_rupiah(item.value)}')
                  .toList(),
            ),
          ...
          pw.Text(
            'Catatan: transfer antar rekening tidak dihitung sebagai pemasukan atau pengeluaran. Piutang juga tidak dianggap pemasukan kas sebelum penerimaan dicatat sebagai transaksi.',
          ),
        ],
      ),
    );
