...
class LiabilityDetailPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final progress = liability.originalAmount <= 0
        ? 0.0
        : (1 - liability.remainingBalance / liability.originalAmount).clamp(
            0.0,
            1.0,
          );
    return Scaffold(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    '${(progress * 100).round()}% sudah terbayar dari ${formatRupiahInput(liability.originalAmount.toString())}',
                  ),
                ],
              ),
            ),
          ...
          AppCard(
            child: Column(
              children: [
                ...
                if (liability.note?.trim().isNotEmpty == true)
                  ListTile(
                    title: const Text('Catatan'),
                    subtitle: Text(liability.note!),
                  ),
              ],
            ),
          ),
