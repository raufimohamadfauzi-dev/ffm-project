  ...
  Widget build(BuildContext context) {
    final features = <_OfflineFeature>[
      ...
      _OfflineFeature(
        ...
        title: 'Scan nota tanpa internet',
        summary: 'Foto nota, lalu aplikasi membaca toko, total, tanggal, kategori, dan rincian barang.',
        where: 'Transaksi > ikon Scan nota di pojok kanan atas.',
        how: 'Kamera mengambil foto nota dan engine OCR lokal mencoba membaca tulisan langsung di perangkat. PaddleOCR dipakai lebih dulu bila tersedia; Google ML Kit menjadi fallback supaya fitur tetap jalan di lebih banyak perangkat. Hasil selalu berupa draf dengan confidence dan status perlu dicek: nama barang, harga, jumlah, tanggal, kategori, dan lampiran gambar bisa dikoreksi sebelum disimpan.',
        steps: const [
          'Buka halaman Transaksi.',
          'Tekan ikon Scan nota, lalu foto nota dengan posisi tegak dan cukup terang.',
          'Periksa nama toko, total, tanggal, kategori, dan barang yang terbaca.',
          'Ketuk item nota untuk mengoreksi nama, harga, atau jumlah; gambar nota ikut jadi lampiran.',
          'Tekan Pakai hasil ini, lengkapi sumber saldo bila perlu, lalu simpan transaksi.',
        ],
        actionLabel: 'Buka Transaksi',
        onOpen: (context) => Navigator.of(
          context,
