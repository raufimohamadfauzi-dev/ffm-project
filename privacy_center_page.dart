          ...
          children: const [
            ...
            AppCard(
              child: ListTile(
                ...
                subtitle: Text('Transaksi, Data Utama, target, hutang, piutang, dan pengaturan disimpan di database perangkat.'),
              ),
            ),
            SizedBox(height: 12),
            AppCard(
              child: ListTile(
                ...
                subtitle: Text('Kalau mau dianalisa di luar aplikasi, ekspor data sendiri dari halaman Ekspor & Cadangan.'),
              ),
            ),
            SizedBox(height: 12),
            AppCard(
              child: ListTile(
                ...
                subtitle: Text('Jangan membagikan berkas JSON ke layanan yang tidak kamu percaya karena isinya dapat memuat rincian keuangan.'),
              ),
            ),
          ],
        ),
