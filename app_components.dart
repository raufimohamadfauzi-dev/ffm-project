        ...
        return InputDecorator(
          decoration: InputDecoration(
            ...
            suffixIcon: Icon(
              ...
              color: enabled ? scheme.onSurfaceVariant : scheme.onSurfaceVariant,
            ),
          ),
          child: Material(
...
class _SearchableDropdownSheetState<T>
  ...
  List<T> get _visibleItems {
    final filtered = widget.items.where((item) {
      return _query.isEmpty || widget.itemLabel(item).toLowerCase().contains(_query);
        ...
        child: Column(
          ...
          children: [
            ...
            if (widget.allowClear && _query.isEmpty)
              ListTile(
                minVerticalPadding: 8,
                leading: Icon(Icons.remove_circle_outline, color: scheme.primary),
                title: Text(widget.clearLabel),
                selected: widget.selectedItem == null,
                onTap: () => Navigator.of(context).pop(
                  _SearchableDropdownAction.clear,
                ),
              ),
            Expanded(
              child: items.isEmpty
