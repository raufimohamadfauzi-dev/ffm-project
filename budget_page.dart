  ...
  Future<void> _load() async {
    final categories =
        await (_database.select(_database.categories)
              ..where((table) => table.type.equals('expense'))
        ...
        child: ListView(
          ...
          children: [
            ...
            SearchableDropdown<int>(
              ...
              helperText:
                  'Contoh: 80% berarti peringatan muncul saat pemakaian mencapai 80%.',
...
class EnvelopeBudgetRow {
  ...
  String get periodLabel => '${startDate.day}/${startDate.month}/${startDate.year} sampai ${endDate.day}/${endDate.month}/${endDate.year}';
}
